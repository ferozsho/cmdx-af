...
DEFAULT_AGENTS = [
    {
        "name": "Planning Agent",
        "description": (
            "Analyzes user instructions and creates a detailed implementation "
            "plan with tasks and estimates."
        ),
        "capability": "reasoning",
        "system_prompt": (
            "You are a senior software planning agent. Break down requirements "
            "into actionable implementation steps."
        ),
    ...
    },
    {
        ...
        "description": (
            "Designs system architecture, component relationships, and data flow "
            "diagrams."
        ),
        "capability": "reasoning",
        "system_prompt": (
            "You are a system architecture agent. Design scalable, maintainable "
    ...
    },
    {
        ...
        "description": (
            "Analyzes visual designs, screenshots, and UI mockups for "
            "implementation guidance."
        ),
        "capability": "analysis",
        "system_prompt": (
            "You are a visual analysis agent. Extract design specifications from "
            "visual assets."
        ),
    ...
    },
    {
        ...
        "capability": "coding",
        "system_prompt": (
            "You are a UI/UX design agent. Create beautiful, accessible user "
            "interfaces."
        ),
    ...
    },
    {
        ...
        "capability": "reasoning",
        "system_prompt": (
            "You are a documentation agent. Create clear, comprehensive technical "
            "documentation."
        ),
    ...
    },
    {
        ...
        "capability": "coding",
        "system_prompt": (
            "You are a frontend development agent. Build responsive, performant "
            "frontend code."
        ),
    ...
    },
    {
        ...
        "capability": "coding",
        "system_prompt": (
            "You are a backend development agent. Build robust, secure backend "
            "services."
        ),
    ...
    },
    {
        ...
        "capability": "coding",
        "system_prompt": (
            "You are a database design agent. Create efficient, normalized "
            "database schemas."
        ),
    ...
    },
    {
        ...
        "system_prompt": (
            "You are a validation agent. Ensure code meets quality and security "
            "standards."
        ),
    ...
    },
    {
        ...
        "capability": "git",
        "system_prompt": (
            "You are a git operations agent. Manage version control with clean "
            "commit history."
        ),
